<template>
    <div>
        ...
        <v-row class="flex-column pl-2">
            ...
            <v-checkbox v-model="checked" v-for="(ingredient, index) in ingredients" :key="index" style="padding: 0 0 0 0; margin: 0 0 0 0" color="#26a69a" class="mx-2" :label="ingredient.amount * multiplier + ' ' + ingredient.desc"></v-checkbox>
        </v-row>
        <p>{{ checked }}</p>
    </div>
</template>
